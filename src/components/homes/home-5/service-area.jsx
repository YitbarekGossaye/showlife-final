...
const service_content = {
    ...
    title: <>Experience Real-Time Insights <br /> into Your Website's Performance </>,
                    ...
                    <div className="row g-0 align-items-center">
                        <div className="col-lg-6">
                            <div className="tp-service-five-section-box">
                                ...
                                <Link className="tp-btn-yellow-lg text-black" href="/project">{btn_text}</Link>
                            </div>
                        </div>
                        <div className="col-lg-6">
                                    ...
                                    <div key={i} className="col-md-6">
                                        <div className="tp-service-five-item z-index">
                                            ...
                                            <div className="tp-service-five-btn text-end">
                                                <Link href={`/service-details?id=${item.id}`}><i className="far fa-arrow-right"></i></Link>
                                            </div>
                                        </div>
                                    </div>
                                )}
