...
const faq_content = {
   ...
   description: <>Find answers to common questions about our web development, hosting, and digital marketing services. <br /> If you need more help, feel free to reach out.</>,
   btn_text: "Contact Us",
};
