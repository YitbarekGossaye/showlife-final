...
const service_content = {
  title: (
    <>
      Transforming Your Digital Presence <br /> with Innovative Solutions
    </>
  ),
  ...
  service_info: (
    <>
      Web Development, Hosting, Marketing, Branding, <br /> E-commerce, SaaS
      Applications
    </>
  ),
};
      ...
      <div className="tp-service-area pb-120 z-index">
        <div className="container">
          ...
          <div className="row">
              ...
              >
                ...
                <div className="tp-service-3-content">
                  ...
                  <h4 className="tp-service-3-title-sm">
                    <Link href={`/service-details?id=${service_data[0].id}`}>{service_info}</Link>
                  </h4>
                </div>
                <div className="tp-service-3-btn">
                  <Link className="tp-btn-white-solid" href={`/service-details?id=${service_data[0].id}`}>
                    Learn More
                  </Link>
                </div>
            ...
            {service_data.slice(17, 21).map((item, i) => (
              <div
                key={i}
              ...
              >
                <div className="tp-service-sm-item mb-30 d-flex flex-column justify-content-between">
                  ...
                  <div className="tp-service-sm-content">
                    ...
                    <p>
                      <Link href={`/service-details?id=${item.id}`}>{item.description}</Link>
                    </p>
