...
const cta_content = { 
   ...
   description: <>Unlock the potential of your business with Showlife’s web development, hosting, and marketing solutions. <br /> Start your journey to success today.</>,
   btn_text: "Learn More",
};
