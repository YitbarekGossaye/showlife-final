...
const company_content ={
    ...
    title: <>ShowLife is Made <br />For Everyone.</>,
    info_1: <>ShowLife is dedicated to providing exceptional digital marketing solutions tailored to meet the diverse needs of businesses. With a focus on innovation and strategic insights, we specialize in maximizing online visibility, driving engagement, and achieving measurable results.</>,
    info_2: <>Our team is committed to delivering impactful campaigns that resonate with target audiences, utilizing cutting-edge techniques in SEO, PPC advertising, social media management, content marketing, email campaigns, and more. Whether you're a startup or an established enterprise, ShowLife is your partner in navigating and succeeding in the digital landscape.</>,
