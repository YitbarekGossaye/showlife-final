            ...
            {items.map((item, i) => 
              <div key={i} data-index={i} className="col-xl-4 col-lg-6 col-md-6 mb-30 grid-item cat1 cat4 cat3 cat5">
                <div className="tp-blog-item">
                  <div className="tp-blog-thumb fix" style={{ position: 'relative', width: '100%', height: '0', paddingBottom: '56.25%' }}>
                  ...
                  <div className="tp-blog-content">
                    ...
                    <div className="tp-blog-author-info-box d-flex align-items-center">
                      <div className="tp-blog-avata" style={{ position: 'relative', width: '50px', height: '50px' }}>
                        <Image
                          src={item.avata_img}
                          alt="theme-pure"
