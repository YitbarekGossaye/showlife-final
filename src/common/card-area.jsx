    ...
    card_images: [
        {
            ...
            cls: "main-img",
            data_parallax: "",
            img: card_img_1, // Update this path if needed
        },
        {
            id: 2,
            cls: "img-1 d-none d-sm-block",
            data_parallax: "",
            img: card_img_2, // Update this path if needed
        },
        {
            id: 3,
            cls: "img-2 d-none d-sm-block",
            data_parallax: '{"x": 50, "smoothness": 30}',
            img: card_img_3, // Update this path if needed
        },
        {
            id: 4,
            cls: "img-3 d-none d-sm-block",
            data_parallax: '{"x": -50, "smoothness": 30}',
            img: card_img_4, // Update this path if needed
        },
        {
            id: 5,
            cls: "img-4 d-none d-sm-block",
            data_parallax: "",
            img: card_img_5, // Update this path if needed
        },
        {
            id: 6,
            cls: "img-5 d-none d-sm-block",
            data_parallax: "",
            img: card_img_6, // Update this path if needed
        },
    ],

    title: <>Showlife’s <span>Innovative Solutions</span> at Your Fingertips</>,
    description: <>Experience the power of Showlife's web development, hosting, and digital marketing services. <br />
    Our solutions are designed to help your business thrive online.</>,
    btn_text: "Contact Us",
};
