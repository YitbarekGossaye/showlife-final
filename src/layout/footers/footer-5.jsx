...
import footer_logo from "../../../public/assets/img/logo/logo-bg1.png";


const footer_content = {
    info:"Build a modern and creative website with ShowLife",
    phone: "0934751319",
    ...
    footer_lisks : [
        ...
        },
        {
            ...
            links: [
               //  {name: "Features", link: "#"},
                {name: "Team", link: "/team"},
                {name: "Ye-Buna", link: "https://ye-buna.com/"},
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 pb-30  wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                           <div className={`tp-footer__widget ${style_team && "tp-footer__input-inner"} footer-widget-3 footer-col-3-1`}>  
                              <div className="tp-footer__logo mb-25">
                                 <Link href="/">
                                    <Image src={footer_logo} alt="" style={{height: "4.5rem", width: "5rem"}} />
                                 </Link>
                              </div>
